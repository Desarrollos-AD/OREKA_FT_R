 ...
 * un panel visual en cada fila impar/par (tal como está en el diseño de
 * Figma). Sin foto real todavía: el panel usa un degradé de marca + el
 * ícono del área en grande, en vez de una foto de stock inventada.
 */
export function FilaServicio({ area, invertida = false }) {
  return (
    <article
      id={area.id}
    ...
    >
      <div className="fila-servicio__texto">
        <div className="fila-servicio__cabecera">
          <span className="fila-servicio__icono">
            <Icono nombre={area.icono} tamano={28} />
          </span>
      ...
      <div className="fila-servicio__panel" aria-hidden="true">
        <span className="fila-servicio__panel-numero">{area.numero}</span>
        <Icono nombre={area.icono} tamano={72} className="fila-servicio__panel-icono" />
      </div>
    </article>
  )
}
