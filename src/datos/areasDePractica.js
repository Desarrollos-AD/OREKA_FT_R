...
export const areasDePractica = [
  {
    id: "fiscal",
    numero: "01",
    icono: "Icono_fiscal.svg",
    titulo: "Derecho Fiscal",
    imagen: "/derecho-fiscal.jpg",
  ...
  },
  {
    id: "administrativo",
    numero: "02",
    icono: "Icono_administrativo.svg",
    titulo: "Derecho Administrativo",
    imagen: "/derecho-administrativo.jpg",
    resumen:
      "Procedimientos y litigios ante autoridades municipales, estatales y federales.",
    parrafos: [
  ...
  },
  {
    id: "corporativo",
    numero: "03",
    icono: "Icono_corporativo.svg",
    titulo: "Derecho Corporativo",
    imagen: "/derecho-corporativo.jpg",
    resumen:
      "Creación y estructura de sociedades, y operación societaria del día a día.",
    parrafos: [
  ...
  },
  {
    id: "laboral",
    numero: "04",
    icono: "Icono_laboral.svg",
    titulo: "Derecho Laboral",
    imagen: "/derecho-laboral.jpg",
    resumen:
      "Despidos, prestaciones, sindicatos y representación patronal en juicios laborales.",
    parrafos: [
  ...
  },
  {
    id: "mercantil",
    numero: "05",
    icono: "Icono_mercantil.svg",
    titulo: "Derecho Mercantil",
    imagen: "/derecho-mercantil.jpg",
    resumen:
      "Contratos y convenios mercantiles, y litigio ejecutivo y ordinario.",
    parrafos: [
  ...
  },
  {
    id: "civil",
    numero: "06",
    icono: "Icono_civil.svg",
    titulo: "Derecho Civil",
    imagen: "/derecho-civil.jpg",
    resumen:
      "Contratos civiles y litigio ante los Tribunales del fuero común o federal.",
    parrafos: [
  ...
  },
  {
    id: "familiar",
    numero: "07",
    icono: "Icono_familiar.svg",
    titulo: "Derecho Familiar",
    imagen: "/derecho-familiar.jpg",
